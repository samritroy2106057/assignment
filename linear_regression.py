...
plt.figure(figsize=(12, 7))
plt.plot(range(len(cost_batch)), cost_batch, 'r-', label='Batch GD')
plt.plot(range(len(cost_stochastic)), cost_stochastic, 'g-', label='Stochastic GD')
plt.plot(range(len(cost_minibatch)), cost_minibatch, 'b-', label='Mini-Batch GD')
